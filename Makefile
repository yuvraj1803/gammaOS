...
./build/fs/file.o ./build/task/process/process.o ./build/task/task.s.o ./build/idt/__0x80/__0x80.o \
 ...
 ./build/idt/__0x80/process/process.o
...
./build/kernel.o: ./kernel/kernel.c
	i686-elf-gcc $(INC) $(FLAGS) -std=gnu99 -c ./kernel/kernel.c -o ./build/kernel.o 

./build/idt/idt.S.o: ./kernel/idt/idt.S
	nasm -f elf -g ./kernel/idt/idt.S -o ./build/idt/idt.S.o
	
./build/idt/idt.o: ./kernel/idt/idt.c
	i686-elf-gcc $(INC) -I./kernel/idt $(FLAGS) -std=gnu99 -c ./kernel/idt/idt.c -o ./build/idt/idt.o 

./build/mm/memory.o: ./mm/memory.c
	i686-elf-gcc $(INC) -I./mm $(FLAGS) -std=gnu99 -c ./mm/memory.c -o ./build/mm/memory.o 

./build/io/io.s.o: ./io/io.s
	nasm -f elf -g ./io/io.s -o ./build/io/io.s.o

./build/mm/heap/heap.o: ./mm/heap/heap.c
	i686-elf-gcc $(INC) -I./mm/heap $(FLAGS) -std=gnu99 -c ./mm/heap/heap.c -o ./build/mm/heap/heap.o 

./build/mm/heap/kheap.o: ./mm/heap/kheap.c
	i686-elf-gcc $(INC) -I./mm/heap $(FLAGS) -std=gnu99 -c ./mm/heap/kheap.c -o ./build/mm/heap/kheap.o 

./build/mm/paging/paging.o: ./mm/paging/paging.c
	i686-elf-gcc $(INC) -I./mm/paging $(FLAGS) -std=gnu99 -c ./mm/paging/paging.c -o ./build/mm/paging/paging.o 
...
./build/drivers/disk/disk.o: ./drivers/disk/disk.c
	i686-elf-gcc $(INC) -I./drivers/disk $(FLAGS) -std=gnu99 -c ./drivers/disk/disk.c -o ./build/drivers/disk/disk.o 


./build/drivers/display/vga/vga.o: ./drivers/display/vga/vga.c
	i686-elf-gcc $(INC) -I./drivers/display/vga $(FLAGS) -std=gnu99 -c ./drivers/display/vga/vga.c -o ./build/drivers/display/vga/vga.o 

./build/fs/parser/parser.o: ./fs/parser/parser.c
	i686-elf-gcc $(INC) -I./fs/parser $(FLAGS) -std=gnu99 -c ./fs/parser/parser.c -o ./build/fs/parser/parser.o

./build/fs/vfs/vfs.o: ./fs/vfs/vfs.c
	i686-elf-gcc $(INC) -I./fs/vfs $(FLAGS) -std=gnu99 -c ./fs/vfs/vfs.c -o ./build/fs/vfs/vfs.o
	
./build/fs/fat16/fat16.o: ./fs/fat16/fat16.c
	i686-elf-gcc $(INC) -I./fs/fat16 $(FLAGS) -std=gnu99 -c ./fs/fat16/fat16.c -o ./build/fs/fat16/fat16.o
	


./build/string/string.o: ./string/string.c
	i686-elf-gcc $(INC) -I./string $(FLAGS) -std=gnu99 -c ./string/string.c -o ./build/string/string.o


./build/gdt/gdt.o: ./kernel/gdt/gdt.c
	i686-elf-gcc $(INC) -I./kernel/gdt $(FLAGS) -std=gnu99 -c ./kernel/gdt/gdt.c -o ./build/gdt/gdt.o
...
./build/task/task.o: ./kernel/task/task.c
	i686-elf-gcc $(INC) -I./kernel/task $(FLAGS) -std=gnu99 -c ./kernel/task/task.c -o ./build/task/task.o

./build/fs/file.o: ./fs/file.c
	i686-elf-gcc $(INC) -I./fs $(FLAGS) -std=gnu99 -c ./fs/file.c -o ./build/fs/file.o
	
./build/task/process/process.o: ./kernel/task/process/process.c
	i686-elf-gcc $(INC) -I./kernel/task/process $(FLAGS) -std=gnu99 -c ./kernel/task/process/process.c -o ./build/task/process/process.o
...
./build/idt/__0x80/__0x80.o: ./kernel/idt/__0x80/__0x80.c
	i686-elf-gcc $(INC) -I./kernel/idt/__0x80 $(FLAGS) -std=gnu99 -c ./kernel/idt/__0x80/__0x80.c -o ./build/idt/__0x80/__0x80.o
	
./build/idt/__0x80/io/io.o: ./kernel/idt/__0x80/io/io.c
	i686-elf-gcc $(INC) -I./kernel/idt/__0x80/io $(FLAGS) -std=gnu99 -c ./kernel/idt/__0x80/io/io.c -o ./build/idt/__0x80/io/io.o
	
./build/drivers/keyboard/keyboard.o: ./drivers/keyboard/keyboard.c
	i686-elf-gcc $(INC) -I./drivers/keyboard $(FLAGS) -std=gnu99 -c ./drivers/keyboard/keyboard.c -o ./build/drivers/keyboard/keyboard.o 

./build/drivers/keyboard/ps2/ps2.o: ./drivers/keyboard/ps2/ps2.c
	i686-elf-gcc $(INC) -I./drivers/keyboard/ps2 $(FLAGS) -std=gnu99 -c ./drivers/keyboard/ps2/ps2.c -o ./build/drivers/keyboard/ps2/ps2.o 

./build/g-loader/elf/elf.o: ./g-loader/elf/elf.c
	i686-elf-gcc $(INC) -I./g-loader/elf $(FLAGS) -std=gnu99 -c ./g-loader/elf/elf.c -o ./build/g-loader/elf/elf.o 
...
./build/idt/__0x80/process/process.o: ./kernel/idt/__0x80/process/process.c
	i686-elf-gcc $(INC) -I./kernel/idt/__0x80/process $(FLAGS) -std=gnu99 -c ./kernel/idt/__0x80/process/process.c -o ./build/idt/__0x80/process/process.o
